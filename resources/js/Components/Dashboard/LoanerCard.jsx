...
export default function LoanerCard({loaner}) {
  ...
  return (
    <>
      <a data-dropdown-toggle={'dropdown'+ loaner.id} data-dropdown-trigger="hover" data-dropdown-delay="100" className="w-28 m-1 block p-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
