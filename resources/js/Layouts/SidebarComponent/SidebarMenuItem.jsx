export default function SidebarMenuItem({url, name, icon}) {
    return (
    <li>
        <a href={url} className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
